...
import cn.snowsoft.iot.module.job.controller.vo.JobLogPageVO;
import cn.snowsoft.iot.module.job.dao.XxlJobGroupDao;
import cn.snowsoft.iot.module.job.dao.XxlJobInfoDao;
import cn.snowsoft.iot.module.job.dao.XxlJobLogDao;
import cn.snowsoft.iot.module.job.core.complete.XxlJobCompleter;
...
import cn.snowsoft.iot.module.job.core.scheduler.XxlJobScheduler;
...
//		JobInfoController.validPermission(request, jobGroup);	// 仅管理员支持查询全部；普通用户仅支持查询有权限的 jobGroup
		...
		Integer start = jobLogPageVO.getPageNo();
		Integer length = jobLogPageVO.getPageSize();
		Integer jobGroup = jobLogPageVO.getJobGroup();
		Integer jobId = jobLogPageVO.getJobId();
		Integer logStatus = jobLogPageVO.getAlarmStatus();
		String filterTime = jobLogPageVO.getFilterTime();
		String executorHandler = jobLogPageVO.getExecutorHandler();
		...
		// page query
		List<XxlJobLog> list = xxlJobLogDao.pageList(start, length, jobGroup, jobId, triggerTimeStart, triggerTimeEnd, logStatus, executorHandler);
		int list_count = xxlJobLogDao.pageListCount(start, length, jobGroup, jobId, triggerTimeStart, triggerTimeEnd, logStatus, executorHandler);
