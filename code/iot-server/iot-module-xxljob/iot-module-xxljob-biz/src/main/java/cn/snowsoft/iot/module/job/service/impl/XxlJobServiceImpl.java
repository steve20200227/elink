package cn.snowsoft.iot.module.job.service.impl;

import cn.snowsoft.iot.module.job.core.cron.CronExpression;
...
import cn.snowsoft.iot.module.job.dao.*;
import cn.snowsoft.iot.module.job.service.XxlJobService;
import cn.snowsoft.iot.module.job.core.model.XxlJobLogReport;
...
import cn.snowsoft.iot.module.job.core.thread.JobTriggerPoolHelper;
import cn.snowsoft.iot.module.job.core.trigger.TriggerTypeEnum;
...
public class XxlJobServiceImpl implements XxlJobService {
	...
	public Map<String, Object> pageList(int start, int length, int jobGroup, int triggerStatus, String jobDesc, String executorHandler, String author, String jobType, Long relevanceId) {
		...
		// page list
		List<XxlJobInfo> list = xxlJobInfoDao.pageList(start, length, jobGroup, triggerStatus, jobDesc, executorHandler, author, jobType, relevanceId);
		int list_count = xxlJobInfoDao.pageListCount(start, length, jobGroup, triggerStatus, jobDesc, executorHandler, author, jobType, relevanceId);
	...
	public ReturnT<String> update(XxlJobInfo jobInfo) {
		...
		exists_jobInfo.setRelevanceId(jobInfo.getRelevanceId());
...
//		}
	...
	@Override
	public List<XxlJobInfo> getByRelevanceId(Long relevanceId, int jobId) {
		return xxlJobGroupDao.getByRelevanceId(relevanceId, jobId);
	}
}
