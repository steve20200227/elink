...
/**
 * @author: chen_gang
 * @date: 2024/8/12 16:53
 * @description: mqtt协议消息发送事件类
 */
@ToString
@Getter
public class MqttWarningEvent extends WarningEvent{
    private final String params;
    public MqttWarningEvent(JSONObject jsonObject, String params, String uuId, Long actionId, WarningDetailVO warningDetailVO, ConfigActionDO configActionDO) {
