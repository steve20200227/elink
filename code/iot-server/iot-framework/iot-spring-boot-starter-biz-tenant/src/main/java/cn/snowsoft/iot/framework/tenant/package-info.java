 ...
 *      1）Spring Async：
 *          {@link cn.snowsoft.iot.framework.quartz.config.YudaoAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 ...
 *
 */
package cn.snowsoft.iot.framework.tenant;
