package cn.snowsoft.iot.framework.websocket.config;

import cn.snowsoft.iot.framework.mq.redis.config.YudaoRedisMQConsumerAutoConfiguration;
import cn.snowsoft.iot.framework.mq.redis.core.RedisMQTemplate;
import cn.snowsoft.iot.framework.websocket.core.handler.JsonWebSocketMessageHandler;
import cn.snowsoft.iot.framework.websocket.core.listener.WebSocketMessageListener;
import cn.snowsoft.iot.framework.websocket.core.security.LoginUserHandshakeInterceptor;
import cn.snowsoft.iot.framework.websocket.core.sender.kafka.KafkaWebSocketMessageConsumer;
import cn.snowsoft.iot.framework.websocket.core.sender.kafka.KafkaWebSocketMessageSender;
import cn.snowsoft.iot.framework.websocket.core.sender.local.LocalWebSocketMessageSender;
import cn.snowsoft.iot.framework.websocket.core.sender.rabbitmq.RabbitMQWebSocketMessageConsumer;
import cn.snowsoft.iot.framework.websocket.core.sender.rabbitmq.RabbitMQWebSocketMessageSender;
import cn.snowsoft.iot.framework.websocket.core.sender.redis.RedisWebSocketMessageConsumer;
import cn.snowsoft.iot.framework.websocket.core.sender.redis.RedisWebSocketMessageSender;
import cn.snowsoft.iot.framework.websocket.core.sender.rocketmq.RocketMQWebSocketMessageConsumer;
import cn.snowsoft.iot.framework.websocket.core.sender.rocketmq.RocketMQWebSocketMessageSender;
import cn.snowsoft.iot.framework.websocket.core.session.WebSocketSessionHandlerDecorator;
import cn.snowsoft.iot.framework.websocket.core.session.WebSocketSessionManager;
import cn.snowsoft.iot.framework.websocket.core.session.WebSocketSessionManagerImpl;
