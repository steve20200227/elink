...
import static cn.snowsoft.iot.module.system.enums.ErrorCodeConstants.NOTICE_NOT_FOUND;
import static cn.snowsoft.iot.module.system.enums.ErrorCodeConstants.NOTIFY_SEND_TEMPLATE_PARAM_MISS;
...
public class NotifySendServiceImpl implements NotifySendService {
    ...
    @Override
    public Long sendNotify(Long userId, Integer userType,NotifyTemplateDO template, Map<String, Object> templateParams) {
        // 校验模版
        // 发送站内信
        String content = notifyTemplateService.formatNotifyTemplateContent(template.getContent(), templateParams);
        return notifyMessageService.createNotifyMessage(userId, userType, template, content, templateParams);
