package cn.snowsoft.iot.module.system.controller.admin.permission;
...
import cn.snowsoft.iot.module.system.controller.admin.permission.vo.role.*;
...
public class RoleController {
    ...
    @Operation(summary = "修改角色")
    @PreAuthorize("@ss.hasPermission('system:role:update')")
    public CommonResult<Boolean> updateRoleStatus(@RequestBody RoleUpdateStatusReqVO updateReqVO) {
        roleService.updateRoleStatus(updateReqVO);
        return success(true);
    }
