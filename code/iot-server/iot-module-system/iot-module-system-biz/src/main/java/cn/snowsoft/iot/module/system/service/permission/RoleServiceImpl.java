package cn.snowsoft.iot.module.system.service.permission;
...
import cn.snowsoft.iot.module.system.controller.admin.permission.vo.role.RolePageReqVO;
import cn.snowsoft.iot.module.system.controller.admin.permission.vo.role.RoleSaveReqVO;
import cn.snowsoft.iot.module.system.controller.admin.permission.vo.role.RoleUpdateStatusReqVO;
import cn.snowsoft.iot.module.system.dal.dataobject.permission.RoleDO;
import cn.snowsoft.iot.module.system.dal.mysql.permission.RoleMapper;
import cn.snowsoft.iot.module.system.dal.mysql.permission.UserRoleMapper;
import cn.snowsoft.iot.module.system.dal.redis.RedisKeyConstants;
import cn.snowsoft.iot.module.system.enums.permission.DataScopeEnum;
...
public class RoleServiceImpl implements RoleService {
    ...
    @Override
    public void updateRoleStatus(RoleUpdateStatusReqVO updateReqVO) {
        // 1.1 校验是否可以更新
        RoleDO role = validateRoleForUpdate(updateReqVO.getId());
        // 2. 更新到数据库
        RoleDO updateObj = BeanUtils.toBean(updateReqVO, RoleDO.class);
