package cn.snowsoft.iot.module.system.controller.admin.notify;
...
import cn.snowsoft.iot.module.system.controller.admin.notify.vo.message.NotifyMessageMyPageReqVO;
import cn.snowsoft.iot.module.system.controller.admin.notify.vo.message.NotifyMessagePageReqVO;
import cn.snowsoft.iot.module.system.controller.admin.notify.vo.message.NotifyMessageRespVO;
import cn.snowsoft.iot.module.system.dal.dataobject.notify.NotifyMessageDO;
import cn.snowsoft.iot.module.system.service.notify.NotifyMessageService;
...
public class NotifyMessageController {
    ...
    @Operation(summary = "获取当前用户的最新站内信列表，默认 20 条")
    @Parameter(name = "size", description = "20")
