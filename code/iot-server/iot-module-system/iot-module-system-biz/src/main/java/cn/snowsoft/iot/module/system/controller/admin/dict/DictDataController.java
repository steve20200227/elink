package cn.snowsoft.iot.module.system.controller.admin.dict;
...
import cn.snowsoft.iot.module.system.controller.admin.dict.vo.data.DictDataRespVO;
import cn.snowsoft.iot.module.system.controller.admin.dict.vo.data.DictDataSaveReqVO;
import cn.snowsoft.iot.module.system.controller.admin.dict.vo.data.DictDataSimpleRespVO;
import cn.snowsoft.iot.module.system.dal.dataobject.dict.DictDataDO;
import cn.snowsoft.iot.module.system.service.dict.DictDataService;
...
import static cn.snowsoft.iot.framework.apilog.core.enums.OperateTypeEnum.EXPORT;
...
public class DictDataController {
    ...
    @PreAuthorize("@ss.hasPermission('system:dict:query')")
    public CommonResult getDictDataList(@RequestParam("dictTypes") String dictTypes) {
        List<String> split = Arrays.asList(dictTypes.split(","));
        return dictDataService.getDictDataLists(split);
    }

    @GetMapping("/type")
    @Operation(summary = "根据字典类型查询字典数据信息")
    @Parameter(name = "type", description = "字典类型", required = true, example = "common_status")
    public CommonResult<List<DictDataRespVO>> getDictDataListByType(@RequestParam("type") String type) {
        List<DictDataDO> list = dictDataService.getDictDataList(
