package cn.snowsoft.iot.module.system.convert.user;

import cn.snowsoft.iot.framework.common.util.collection.CollectionUtils;
import cn.snowsoft.iot.framework.common.util.collection.MapUtils;
import cn.snowsoft.iot.framework.common.util.object.BeanUtils;
import cn.snowsoft.iot.module.system.controller.admin.dept.vo.dept.DeptSimpleRespVO;
import cn.snowsoft.iot.module.system.controller.admin.dept.vo.post.PostSimpleRespVO;
import cn.snowsoft.iot.module.system.controller.admin.permission.vo.role.RoleSimpleRespVO;
import cn.snowsoft.iot.module.system.controller.admin.user.vo.profile.UserProfileRespVO;
import cn.snowsoft.iot.module.system.controller.admin.user.vo.user.UserRespVO;
import cn.snowsoft.iot.module.system.controller.admin.user.vo.user.UserSimpleRespVO;
