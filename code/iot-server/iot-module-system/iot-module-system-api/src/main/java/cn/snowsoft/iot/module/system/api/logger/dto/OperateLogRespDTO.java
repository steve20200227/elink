package cn.snowsoft.iot.module.system.api.logger.dto;
...
public class OperateLogRespDTO implements VO {
    ...
    /*@Trans(type = TransType.RPC, targetClassName = "cn.snowsoft.iot.module.system.dal.dataobject.user.AdminUserDO",
