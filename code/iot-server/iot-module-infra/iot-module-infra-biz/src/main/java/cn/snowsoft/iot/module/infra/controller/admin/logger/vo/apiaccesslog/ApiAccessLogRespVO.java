package cn.snowsoft.iot.module.infra.controller.admin.logger.vo.apiaccesslog;
...
import cn.snowsoft.iot.module.system.enums.DictTypeConstants;
...
public class ApiAccessLogRespVO {
    ...
    @DictFormat(cn.snowsoft.iot.module.infra.enums.DictTypeConstants.OPERATE_TYPE)
    ...
    @Schema(description = "结果提示", example = "chengang，牛逼！")
    @ExcelProperty("结果提示")
