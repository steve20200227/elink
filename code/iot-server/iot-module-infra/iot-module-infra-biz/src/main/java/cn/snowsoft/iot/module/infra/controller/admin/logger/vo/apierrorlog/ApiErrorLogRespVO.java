package cn.snowsoft.iot.module.infra.controller.admin.logger.vo.apierrorlog;
...
import cn.snowsoft.iot.module.infra.enums.DictTypeConstants;
...
public class ApiErrorLogRespVO {
    ...
    @DictFormat(cn.snowsoft.iot.module.system.enums.DictTypeConstants.USER_TYPE)
